...
const Hero = () => {
    ...
    return (
        <Container>
            <Grid container sx={{ my: "50px", justifyContent: "center", alignItems: "center" }}>
                <Grid item md={6} xxs={12} sx={{ display: "flex", justifyContent: "center", alignItems: "center" }}>
                    <Stack gap={1} textAlign="center">

                        <Typography
                            sx={{
                                fontSize: { xxs: "50px", sm: "70px" },
                                marginTop: { xxs: "30px", md: "0" },
                        ...
                        <Stack sx={{ margin: "auto", width: { xxs: "100%", sm: "400px" }, gap: "20px" }}>
                ...
                <Grid item md={6} xxs={12} sx={{ justifyContent: "center", alignItems: "center" }}>
